...
int strsplit(char* str, char** fields, const char* delim, int maxfields=MAX_INT);
...
int strsplit(char* str, char** fields, int maxfields=MAX_INT); //splits by tab or space
